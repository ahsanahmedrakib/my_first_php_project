...
<div class="panel panel-primary">
    <?php include '../message.php' ?>
                <div class="panel-heading">
                            <div class="col-md-9 heading_title">Services Edit</div>
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="services_add">
                    
                    
                          <form class="form-horizontal" action="services_edit_post.php" method="POST">
