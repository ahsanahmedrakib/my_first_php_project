...
<div class="panel panel-primary">
                ...
                <div class="panel-heading">
                            <div class="col-md-9 heading_title">Team Edit</div>
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="team_add">
                    
                    
                          <form class="form-horizontal" action="team_edit_post.php" method="POST">
