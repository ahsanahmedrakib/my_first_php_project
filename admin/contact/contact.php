  ...
  <?php include "../message.php" ?>
    <div class="panel panel-primary">
                ...
                <div class="panel-heading">
                            <div class="col-md-9 heading_title">Contact</div>
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <?php foreach($query as $value) { ?>
                                                                    <tr class="">
                                                                        ...
                                                                        <td><a href="contact_edit.php?id=<?php echo $value['id'] ?>"><button class="btn btn-success" type="submit">Edit</button></a></td>
                                                                        <?php if($_SESSION['type'] == 1) { ?>
                                                                        <td><a href="contact_delete.php?id=<?php echo $value['id'] ?>"><button class="btn btn-danger" type="submit">Delete</button></a></td>
                                                                        <?php } ?>
                                                                    </tr>
                                                            <?php } ?>
